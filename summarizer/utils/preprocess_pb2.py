...
_TOKENIZATIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="input",
            full_name="zemberek.preprocessor.TokenizationRequest.input",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="includeTokenBoundaries",
            full_name="zemberek.preprocessor.TokenizationRequest.includeTokenBoundaries",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="ignoreDoubleQuotes",
            full_name="zemberek.preprocessor.TokenizationRequest.ignoreDoubleQuotes",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
...
_TOKENPROTO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token",
            full_name="zemberek.preprocessor.TokenProto.token",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="zemberek.preprocessor.TokenProto.type",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="start",
            full_name="zemberek.preprocessor.TokenProto.start",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="end",
            full_name="zemberek.preprocessor.TokenProto.end",
            index=3,
            number=4,
            type=5,
            cpp_type=1,
...
_TOKENIZATIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="tokens",
            full_name="zemberek.preprocessor.TokenizationResponse.tokens",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SENTENCEEXTRACTIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="document",
            full_name="zemberek.preprocessor.SentenceExtractionRequest.document",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="doNotSplitInDoubleQuotes",
            full_name="zemberek.preprocessor.SentenceExtractionRequest.doNotSplitInDoubleQuotes",
            index=1,
            number=2,
            type=8,
            cpp_type=7,
...
_SENTENCEEXTRACTIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="sentences",
            full_name="zemberek.preprocessor.SentenceExtractionResponse.sentences",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
] = _SENTENCEEXTRACTIONREQUEST
DESCRIPTOR.message_types_by_name[
    "SentenceExtractionResponse"
] = _SENTENCEEXTRACTIONRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

TokenizationRequest = _reflection.GeneratedProtocolMessageType(
    "TokenizationRequest",
    (_message.Message,),
    dict(
...
TokenProto = _reflection.GeneratedProtocolMessageType(
    "TokenProto",
    (_message.Message,),
    dict(
...
TokenizationResponse = _reflection.GeneratedProtocolMessageType(
...
SentenceExtractionRequest = _reflection.GeneratedProtocolMessageType(
    "SentenceExtractionRequest",
    (_message.Message,),
    dict(
...
SentenceExtractionResponse = _reflection.GeneratedProtocolMessageType(
    "SentenceExtractionResponse",
    (_message.Message,),
    dict(
