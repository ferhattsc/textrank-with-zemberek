...
_LANGUAGEIDREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="input",
            full_name="zemberek.langid.LanguageIdRequest.input",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="maxSampleCount",
            full_name="zemberek.langid.LanguageIdRequest.maxSampleCount",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_LANGUAGEIDRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="langId",
            full_name="zemberek.langid.LanguageIdResponse.langId",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
LanguageIdRequest = _reflection.GeneratedProtocolMessageType(
    "LanguageIdRequest",
    (_message.Message,),
    dict(
...
LanguageIdResponse = _reflection.GeneratedProtocolMessageType(
    "LanguageIdResponse",
    (_message.Message,),
    dict(
